# Esto es la version app(la beta)
#<-------------------------------->
##FILES##
...
##NEEDED IMPORTS##
import random, time, hashlib,poplib,stdiomask
...
def index2():
    ...
    l = input()
    if l == "pasar":
        f = Get_DB(LoginDB,"Isabel","",Login_Cur,"LoginDetails","User","","Maybe")
        transportationZone("Isabel")
    else:
        Start()
